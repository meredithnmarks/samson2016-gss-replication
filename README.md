...
This project:
- Reproduces the principal analyses and tables from "Support for immigration reduction and physician distrust in the United States" Samson (2016) using the 2012 General Social Survey (GSS).
